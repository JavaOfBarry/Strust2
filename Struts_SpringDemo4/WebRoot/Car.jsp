...
<%@ page language="java" import="com.wwb.entity.*" %>
...
<html>
  ...
  <body>
	...
	<table align="center" width="70%" cellspacing="0" cellpadding="0" border=1>
      <tr align="center">
        <td>商品名称</td><td>商品价格</td><td>商品描述</td><td>商品图片</td><td>商品数量</td><td>操作</td>
      </tr>
     <s:iterator value="#session.car" >
			<tr>
				...
				<td align="center"> <a
					href="deleteCar.action?id=<s:property value='id'/>">删除商品</a></td>
			</tr>
		</s:iterator>
		 <tr>
    <td >总额：</td>
    ...
    <tr>
    <td ><a href="selectThingsDJ.action"/>返回</a></td>
